# gets tweets in a json file

#!/usr/bin/env python
"""
Example usage:
    python capture_data.py @mcdonalds
...
This will produce a file called line_separated_tweets.json It is used by
later scripts.
"""
...
max_tweets          = 1000
output_file_name    = 'line_separated_tweets.json'
...
if __name__ == "__main__":
    ...
    twitter_api = twitter.Api(consumer_key='fd5TwZfTmZR4J8qMq0THM7sQh',
