...
response = client.create_data_source_from_s3(
    ...
    DataSourceName='[DS BT3] training 001',
    DataSpec={
        'DataLocationS3': 's3://aml.packt/data/ch8/ames_housing.csv',
        'DataRearrangement': '{\"splitting\":{\"percentBegin\":0,\"percentEnd\":70}}',
        'DataSchemaLocationS3': 's3://aml.packt/data/ch8/ames_housing.csv.schema'
    },
...
response = client.create_data_source_from_s3(
    ...
    DataSourceName='[DS BT3] validation 001',
    DataSpec={
        'DataLocationS3': 's3://aml.packt/data/ch8/ames_housing.csv',
